  ...
  },
  {
    ...
    description: (
      <>
        ...
        , our submission for a COVID-19 global hackathon. An app which suggests
        what to do to keep sane while using your browser, and rewards you with
        cute pets for maintaining streaks.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    description: (
      <>
        ...
        for a low-stakes, chill game... And I want to follow along with{' '}
        <a
          href="https://www.patreon.com/minnmax"
          className="underline text-purple-400"
          rel="noopener noreferrer"
        >
          the MinnMax game club
        </a>
        !
      </>
    ),
