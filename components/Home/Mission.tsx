...
export const Mission = () => (
  <section className="container m-auto p-8">
    ...
    <div className="m-auto" style={{ maxWidth: '80ch' }}>
      ...
      <p className="mb-2">
        But humans are complicated creatures and I refuse to take one of my many
        interests to the extreme and reduce “my brand” to one easily digestible
        bit.
      </p>
      <p className="mb-2">
        I’m not going to choose between creating content exclusively for
        landscape photography, or for 4X strategy video games, or for practicing
        handstands. I’m not gonna create a “Frontend specialist” brand, to
        complement the “evangelising GraphQL” brand, while promoting the
