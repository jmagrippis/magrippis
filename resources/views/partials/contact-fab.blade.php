<md-fab-speed-dial md-direction="up" class="contact md-fling">
    ...
    <md-fab-actions>
        <md-button aria-label="facebook" class="md-fab md-raised md-mini">
            <md-icon><a href="https://www.facebook.com/jmagr"><i class="fa fa-facebook"></i></a></md-icon>
        </md-button>
        <md-button aria-label="twitter" class="md-fab md-raised md-mini">
            <md-icon><a href="https://twitter.com/magrippinho"><i class="fa fa-twitter"></i></a></md-icon>
        </md-button>
